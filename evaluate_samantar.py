...
def beam_search_decode(model, src_tensor, beam_width, max_len, device, sos_token, eos_token, pad_token):
    ...
    # ... [beam search logic remains the same]
...
def main():
    print("--- Starting Evaluation for From-Scratch Model ---")
    ...
    print("Loading test dataset from Samanantar...")
    test_dataset = load_from_disk("processed_samanantar_data")['validation']
